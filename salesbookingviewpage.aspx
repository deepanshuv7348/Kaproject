<%@ Page Language="C#" AutoEventWireup="true" CodeFile="salesbookingviewpage.aspx.cs" Inherits="salesbookingviewpage" %>
...
<body>
    ...
    <nav>
      <div class="sidebar-button">
        ...
        <span class="dashboard"> SalesBooking Details</span>
      </div>
          ...
          <ItemTemplate> 
              ...
              <td>  
               ...
               <%# Eval("SealingRate")%>  
                  ...
                  <td><asp:button ID="Update" text="Update" runat="server"  cssclass="btn btn-primary "  BackColor="green" CommandName="Update" CommandArgument='<%# Eval("id") %>'  /></td>
                  <td><asp:Button ID="Delete" Text="Delete" runat="server" cssclass="btn btn-primary " BackColor="red" CommandName="Delete"  OnClientClick="return confirm('Are you sure you want to delete this Record?');" CommandArgument='<%# Eval("id") %>'  /></td>
                    </ItemTemplate>  
            </asp:ListView>
         </div>   
